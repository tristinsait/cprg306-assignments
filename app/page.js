...
export default function Home() {
  return (
    <main>
      ...
      <Link href="/week-9" className="hover:text-pink-300 hover:underline">Week 9 Assignment</Link> <br></br>
      <Link href="/week-10" className="hover:text-pink-300 hover:underline">//placeholder// Week 10 Assignment</Link> <br></br>
    </main>
  );
}